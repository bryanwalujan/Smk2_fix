    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="overflow-x-auto">
                <table class="w-full" id="classroomTable">
                    ...
                    <tbody class="divide-y divide-gray-200" id="classroomTableBody">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.getElementById('searchInput').addEventListener('input', function(e) {
                ...
                const rows = document.querySelectorAll('#classroomTableBody tr:not(#emptyRow)');
                const noResults = document.getElementById('noResults');
                const emptyRow = document.getElementById('emptyRow');
                let hasVisibleRows = false;

                // Sembunyikan pesan "Tidak ada data kelas tersedia" jika ada input pencarian
                if (emptyRow) {
